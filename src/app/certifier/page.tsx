    ...
    <div className="max-w-3xl mx-auto px-6 py-14">
      ...
      {step === "form" && (
        <div className="space-y-8">
          ...
          <div className="bg-surface-2 border border-border rounded p-6 space-y-2">
            ...
            <div>
              ...
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 bg-surface-2 border border-border rounded px-3 py-2 text-sm font-mono text-text-primary placeholder:text-text-muted focus:outline-none focus:border-accent/50"
                />
                <button
                  onClick={lookupDoi}
      ...
      {step === "preview" && crossref && (
        <div className="space-y-6">
          ...
          <div className="bg-surface-2 border border-border rounded p-5 space-y-4">
            <div>
          ...
          <div>
            ...
            <div
              ...
              className="border-2 border-dashed border-border hover:border-accent/40 rounded p-8 text-center cursor-pointer transition-colors"
            >
              {file ? (
                <div>
          ...
          <div className="flex gap-3">
            <button
              ...
              className="bg-accent hover:bg-accent-hover text-white text-sm font-mono px-6 py-2.5 rounded transition-colors disabled:opacity-50 cursor-pointer"
            >
              {submitting ? "Émission du KPT..." : "Certifier et émettre le KPT"}
            </button>
            <button
              onClick={() => { setStep("form"); setCrossref(null); setFile(null); }}
              className="border border-border text-text-secondary hover:text-text-primary text-sm font-mono px-6 py-2.5 rounded transition-colors bg-transparent cursor-pointer"
            >
              Retour
            </button>
          </div>
      ...
      {step === "success" && kptResult && (
        <div className="space-y-8">
          ...
          <div className="bg-surface-2 border border-accent/20 rounded p-6 space-y-4">
          ...
          <div className="flex gap-3">
            <Link
              href={`/verify?kpt_id=${kptResult.kpt_id}`}
              className="no-underline bg-accent hover:bg-accent-hover text-white text-sm font-mono px-6 py-2.5 rounded transition-colors"
            >
              Vérifier ce KPT →
            </Link>
            <Link
              href="/publications"
              className="no-underline border border-border text-text-secondary hover:text-text-primary text-sm font-mono px-6 py-2.5 rounded transition-colors"
            >
